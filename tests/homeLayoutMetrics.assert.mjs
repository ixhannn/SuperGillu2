...
assert.equal(HOME_LAYOUT_METRICS.topGapPx, 8, 'Expected the home screen top gap to stay tight above the profile row');
...
assert.equal(HOME_LAYOUT_METRICS.overlayExtraTopPx, 8, 'Expected the fixed top chrome to match the compact home header spacing');
