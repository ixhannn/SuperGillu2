 ...
 *
 * Three slowly drifting color pools (CSS keyframes drift-1/2/3).
  ...
  >
    ...
    <div
      ...
      style={{
        ...
        top: '-15%', left: '-15%',
        background: 'var(--theme-orb-1, radial-gradient(circle, rgba(251,207,232,0.20) 0%, rgba(244,114,182,0.06) 50%, transparent 70%))',
        filter: 'blur(72px)',
        borderRadius: '50%',
      }}
    />
    ...
    <div
      ...
      style={{
        ...
        bottom: '-12%', right: '-12%',
        background: 'var(--theme-orb-2, radial-gradient(circle, rgba(249,168,212,0.16) 0%, rgba(251,207,232,0.05) 50%, transparent 70%))',
        filter: 'blur(80px)',
        borderRadius: '50%',
      }}
    />
    ...
    <div
      ...
      style={{
        ...
        top: '25%', left: '22%',
        background: 'var(--theme-orb-3, radial-gradient(circle, rgba(251,207,232,0.14) 0%, rgba(244,114,182,0.04) 50%, transparent 70%))',
        filter: 'blur(88px)',
        borderRadius: '50%',
      }}
    />
