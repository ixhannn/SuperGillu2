...
export const ROOM_SHOP: RoomCatalogItem[] = [
  { id: 'double_bed', name: 'Cloudline Bed', kind: 'bed', category: 'furniture', cost: 180, rarity: 'rare', color: '#ff6fa8', idle: 'none', footprint: [2, 2], height: 0.82, scale: 1.05, visualType: 'angled-plane', spriteSize: [1.9, 1.45], roomLevelReq: 2, effectText: 'A soft focal piece for your room.', gameplayTags: ['cozy', 'rest', 'functional'] },
  { id: 'gaming_chair', name: 'Sunset Chair', kind: 'chair', category: 'furniture', cost: 130, rarity: 'common', color: '#ef4444', idle: 'bounce', footprint: [1, 1], height: 0.95, visualType: 'angled-plane', spriteSize: [0.95, 1.3], effectText: 'Pairs beautifully with desks and reading corners.', gameplayTags: ['creator', 'support'] },
  ...
  { id: 'bookshelf_overflow', name: 'Story Shelf', kind: 'bookshelf', category: 'furniture', cost: 140, rarity: 'rare', color: '#f59e0b', idle: 'none', footprint: [1, 1], height: 1.25, visualType: 'angled-plane', spriteSize: [1.05, 1.7] },
  { id: 'l_desk', name: 'Writing Desk', kind: 'desk', category: 'furniture', cost: 145, rarity: 'common', color: '#f97316', idle: 'none', footprint: [2, 1], height: 0.8, visualType: 'angled-plane', spriteSize: [1.9, 1.3], effectText: 'A grounded anchor for your shared corner.', gameplayTags: ['creator', 'functional', 'core'] },
  { id: 'fluffy_couch', name: 'Snuggle Sofa', kind: 'couch', category: 'furniture', cost: 160, rarity: 'rare', color: '#fb7185', idle: 'none', footprint: [2, 1], height: 0.72, visualType: 'angled-plane', spriteSize: [1.7, 1.12] },
  ...
  { id: 'tv_stand_screen', name: 'Movie Night Console', kind: 'tv', category: 'furniture', cost: 175, rarity: 'rare', color: '#60a5fa', idle: 'twinkle', footprint: [2, 1], height: 0.86, visualType: 'angled-plane', spriteSize: [1.75, 1.2], playerLevelReq: 2, effectText: 'Perfect for long cozy evenings.', gameplayTags: ['creator', 'functional', 'tech'] },
  ...
  { id: 'photo_frames', name: 'Memory Frames', kind: 'frame', category: 'decor', cost: 80, loveCost: 12, rarity: 'common', color: '#93c5fd', idle: 'none', footprint: [1, 1], height: 0.88, mount: 'back-wall', visualType: 'billboard', spriteSize: [0.92, 1.08], anchorHeight: 1.52, effectText: 'A place for your favorite moments.', gameplayTags: ['memory', 'couple', 'decor'] },
  ...
  { id: 'record_player', name: 'Record Player', kind: 'record', category: 'cozy', cost: 122, rarity: 'rare', color: '#818cf8', idle: 'spin', footprint: [1, 1], height: 0.52, roomLevelReq: 2, effectText: 'Brings a little soundtrack into the space.', gameplayTags: ['memory', 'cozy', 'functional'] },
  ...
  { id: 'pet_nook', name: 'Pet Nook', kind: 'pillows', category: 'cozy', cost: 110, rarity: 'rare', color: '#f59e0b', idle: 'bounce', footprint: [1, 1], height: 0.52, visualType: 'billboard', spriteSize: [0.96, 0.78], effectText: 'A soft corner for your little companion.', gameplayTags: ['pet', 'cozy'] },
  ...
  { id: 'memory_shelf', name: 'Memory Shelf', kind: 'bookshelf', category: 'special', cost: 145, rarity: 'rare', color: '#c084fc', idle: 'none', footprint: [1, 1], height: 1.1, visualType: 'angled-plane', spriteSize: [1.04, 1.58], effectText: 'A shelf for photos, tiny keepsakes, and shared stories.', gameplayTags: ['memory', 'cozy'] },
  { id: 'rainy_window', name: 'Rainy Window', kind: 'window', category: 'seasonal', cost: 135, rarity: 'rare', color: '#8cb4ff', idle: 'twinkle', footprint: [1, 1], height: 1.02, mount: 'back-wall', visualType: 'billboard', spriteSize: [1.02, 1.18], anchorHeight: 1.62, effectText: 'A soft rainy-day mood for the room.', gameplayTags: ['seasonal', 'memory'] },
  { id: 'winter_wreath', name: 'Winter Wreath', kind: 'frame', category: 'seasonal', cost: 120, rarity: 'rare', color: '#86efac', idle: 'twinkle', footprint: [1, 1], height: 0.88, mount: 'back-wall', visualType: 'billboard', spriteSize: [0.94, 1.02], anchorHeight: 1.62, effectText: 'A festive little welcome for winter evenings.', gameplayTags: ['seasonal', 'decor'] },
  { id: 'valentine_ribbon', name: 'Valentine Ribbon', kind: 'lights', category: 'seasonal', cost: 118, rarity: 'rare', color: '#fb7185', idle: 'twinkle', footprint: [2, 1], height: 1, mount: 'back-wall', visualType: 'billboard', spriteSize: [2.08, 0.96], anchorHeight: 2.02, effectText: 'A romantic seasonal accent.', gameplayTags: ['seasonal', 'romantic'] },
  { id: 'birthday_bunting', name: 'Birthday Bunting', kind: 'lights', category: 'seasonal', cost: 118, rarity: 'rare', color: '#fbbf24', idle: 'twinkle', footprint: [2, 1], height: 1, mount: 'back-wall', visualType: 'billboard', spriteSize: [2.08, 0.96], anchorHeight: 2.02, effectText: 'A joyful banner for birthdays and surprises.', gameplayTags: ['seasonal', 'fun'] },
];
