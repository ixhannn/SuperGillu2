...
- Name: visualParity.spec.ts >> visual parity: daily-moments
...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  5424 pixels (ratio 0.02 of all image pixels) are different.

  Snapshot: daily-moments-393.png

Call log:
  - Expect "toHaveScreenshot(daily-moments-393.png)" with timeout 5000ms
    - verifying given screenshot expectation
  - taking page screenshot
    - disabled all CSS animations
  - waiting for fonts to load...
  - fonts loaded
  - 5010 pixels (ratio 0.02 of all image pixels) are different.
...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e2]:
    - main [ref=e3]:
      - generic [ref=e7]:
        ...
        - generic [ref=e11]:
          - img [ref=e15]
          - heading "Capture a moment that fades away." [level=2] [ref=e18]:
            - text: Capture a moment
            - text: that fades away.
          - paragraph [ref=e19]: Visible for 24 hours
    - generic [ref=e21]:
  ...
  - banner [ref=e50]:
    - button "Go back" [ref=e51] [cursor=pointer]:
      - img [ref=e52]
    - generic [ref=e54]:
      - heading "Moments" [level=2] [ref=e55]
      - paragraph [ref=e56]: Ephemeral Memories
    - generic [ref=e58]:
      - button "Share a photo moment" [ref=e59] [cursor=pointer]:
        - img [ref=e60]
      - button "Share a video moment" [ref=e63] [cursor=pointer]:
        - img [ref=e64]
```
