...
export default {
    ...
    theme: {
        extend: {
            ...
            fontFamily: {
                sans: ['var(--font-ui)', '"Afacad Flux"', 'ui-sans-serif', 'system-ui', 'sans-serif'],
                body: ['var(--font-ui)', '"Afacad Flux"', 'ui-sans-serif', 'system-ui', 'sans-serif'],
                serif: ['var(--font-display)', '"Bricolage Grotesque"', 'ui-sans-serif', 'system-ui', 'sans-serif'],
                display: ['var(--font-display)', '"Bricolage Grotesque"', 'ui-sans-serif', 'system-ui', 'sans-serif'],
                mono: ['JetBrains Mono', 'ui-monospace', 'monospace'],
            },
            fontSize: {
                'display': ['2.5rem', { lineHeight: '1.05', letterSpacing: '0', fontWeight: '700' }],
                'headline': ['1.75rem', { lineHeight: '1.12', letterSpacing: '0', fontWeight: '700' }],
                'title': ['1.375rem', { lineHeight: '1.16', letterSpacing: '0', fontWeight: '650' }],
